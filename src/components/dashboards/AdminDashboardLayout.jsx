...
export const AdminSidebar = ({ children }) => {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      >
        {/* Logo Header */}
        <div className="flex flex-col items-center justify-center h-28 border-b border-blue-800/30 bg-gradient-to-r from-blue-800/20 to-purple-800/20 relative">
          <Link href="/dashboard/admin" className="flex items-center space-x-3 mt-2">
            <img
              src="/logo.png"
              alt="Digital Library Logo"
                className="object-contain rounded-lg shadow-md h-16"
              />
              {/* <span className="text-2xl font-bold text-white tracking-wide">Digital Library</span> */}
            </Link>
            {/* Text below the logo */}
            <span className="mt-2 text-white text-sm font-semibold tracking-wide">Digital Library</span>
            <button
